package com.tamires.course.config;

import com.tamires.course.entities.*;
import com.tamires.course.entities.enuns.OrderStatus;
import com.tamires.course.repositories.*;
...
public class TestConfig implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    orderItemRepository.saveAll(Arrays.asList(oi2,oi1,oi3,oi4));
